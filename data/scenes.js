...
window.SCENES =
{
  ...
  "scenes": [
    ...
    },
    {
      ...
      "body_mn": "Тэр жил чи надад шүлэг бичиж өгсөн.",
      "verse_mn": [
      ...
      "verse_caption_mn": "— чиний бичсэн шүлэг, 2021",
      "after_mn": "Би энэ шүлгийг таван жил хадгалсан.",
      "headline_ko": "두 번째 해",
      "body_ko": "그 해 너는 나에게 시를 써주었어.",
      "after_ko": "나는 이 시를 5년간 간직했어.",
      "media": null
    },
    {
      "id": "S04",
      ...
      "headline_mn": "Хүлээлт",
      "body_mn": "Хоёр байсан бид гурав болохыг хүлээж байлаа. Чи тэр бүх хугацаанд ганц ч удаа гомдоллоогүй.",
      "headline_ko": "기다림",
      "body_ko": "둘이던 우리가 셋이 되기를 기다렸어. 너는 그 시간 내내 한 번도 힘들다는 말을 안 했어.",
      "gallery": [
    ...
    },
    {
      ...
      "headline_mn": "Нар мандахыг хамт харсан",
      "body_mn": "Хүүхдүүд унтаж байхад бид хоёр нар мандахыг харлаа. Ийм чимээгүй хором хоёуланд маань ховор.",
      "headline_ko": "함께 본 일출",
      "body_ko": "아이들이 자는 동안 우리 둘은 해가 뜨는 걸 봤어. 이런 조용한 순간은 우리 둘 다에게 드물어.",
    ...
    },
    {
      ...
      "headline_mn": "Хоёулаа",
      "body_mn": "Олон жилийн дараа дахин хоёулаа. Тэр өдөр чи анх уулзсан өдрийнх шигээ инээж байлаа.",
      "headline_ko": "둘이서",
      "body_ko": "오랜만에 다시 둘이서. 그날 너는 처음 만난 날처럼 웃고 있었어.",
    ...
    },
    {
      ...
      "headline_mn": "Цэцэрлэгийн анхны өдөр",
      "body_mn": "Эрмүүн маань цэцэрлэгт орлоо. Чи түүнийг хөтлөөд явахыг би хараад удтал зогсов.",
      "headline_ko": "유치원 첫날",
      "body_ko": "우리 에르뭉이 유치원에 들어갔어. 네가 그 애 손을 잡고 걸어가는 걸 나는 한참 서서 봤어.",
      "media": { "src": "assets/img/2026-kindergarten-01.jpg", "w": 1200, "h": 1600, "alt_mn": "Цэцэрлэгийн анхны өдөр" }
    },
    {
      "id": "S23",
      "layout": "text-only",
    ...
    },
    {
      ...
      "enter": "verse-cascade",
      "theme": "dark",
      "eyebrow_mn": "Таван жилийн өмнөх шүлэгт чинь хариу",
      "verse_mn": [
