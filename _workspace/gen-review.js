...
var NOTES = {
  ...
  S01b: '새로 주신 젊은 시절 사진 8장(연애 시절 6 + 2020년 산 정상 2)으로 만든 신규 씬입니다. "그때보다 지금이 더 예쁘다"는 흔한 말 대신 **"웃음만은 하나도 안 변했다"**로 썼습니다.',
  S01c: '⭐ **6년 전 바로 오늘(2020.09.07) 아내분 생일 사진**입니다. 날짜가 오늘과 정확히 같아서, 마지막 생일 편지(S25)와 페이지 양 끝에서 맞물립니다. 새로 주신 사진 중 가장 값진 한 장입니다.',
  S03: '처음엔 \"둘만 있던 마지막 해\"로 썼다가 정정했습니다. 의도는 \"둘만의 시간이 끝나가던 해\"였지만 몽골어 сүүлчийн жил 이 그냥 \"마지막 해\"로 읽혀 불길합니다. 생일 페이지에 쓸 단어가 아닙니다.',
  ...
  S25: '오늘(9/7) 생일 편지. 호칭을 `хайрт минь`(내 사랑)로 바꿨습니다 — 작년에 형님이 실제로 쓰신 표현입니다.<br>출근하셨으니 "집안일 잊고 쉬어"는 지킬 수 없는 말이라 뺐습니다. 대신 "일터에 있지만 아침부터 마음은 너와 함께 있다"로 사실을 인정하고, **"저녁에 가서 나머지는 내가 할게"**로 오늘 실제로 지킬 수 있는 약속을 넣었습니다.<br>⚠ 저녁에 정말 못 하실 상황이면 그 문장은 빼는 게 낫습니다. 못 지킬 약속이 제일 티가 납니다.',
